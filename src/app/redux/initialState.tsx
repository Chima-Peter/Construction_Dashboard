...
export const InitialState: ProjectProps[] = [
  ...
  },
  {
    projectDetails: {
      ...
      manager: 'David Smith',
      progress: 100,
      startDate: new Date('2022-03-01').toDateString(),
      endDate: new Date('2023-03-01').toDateString(),
      keyDetails: [
  ...
  },
  {
    projectDetails: {
      ...
      manager: 'Emma Brown',
      progress: 100,
      startDate: new Date('2022-05-01').toDateString(),
  ...
  // Near Completion
  {
    projectDetails: {
      ...
      progress: 93,
      startDate: new Date('2023-02-01').toDateString(),
      endDate: new Date('2024-09-01').toDateString(),
      keyDetails: [
        'Roofing completed',
  ...
  },
  {
    projectDetails: {
      ...
      progress: 87,
      startDate: new Date('2022-08-01').toDateString(),
      endDate: new Date('2024-05-01').toDateString(),
      keyDetails: [
  ...
  },
  {
    projectDetails: {
      ...
      endDate: new Date('2024-10-01').toDateString(),
      keyDetails: [
